...
bool is_valid(BetxReadError constant) noexcept {
   switch (constant) {
      ...
      case BetxReadError::unsupported_span_granularity:
      case BetxReadError::noncanonical_span_granularity:
...
const char* betx_read_error_name(BetxReadError constant) noexcept {
   switch (constant) {
      ...
      case BetxReadError::unsupported_span_granularity:  return "unsupported_span_granularity";
      case BetxReadError::noncanonical_span_granularity: return "noncanonical_span_granularity";
...
int texture_file_error_condition(BetxReadError constant) noexcept {
   switch (constant) {
      ...
      case BetxReadError::unsupported_span_granularity:  return static_cast<int>(TextureFileError::unsupported);
...
int generic_error_condition(BetxReadError constant) noexcept {
   switch (constant) {
      ...
      case BetxReadError::unsupported_span_granularity:  return static_cast<int>(std::errc::not_supported);
...
const char* read_error_msg(BetxReadError constant) noexcept {
   switch (constant) {
      ...
      case BetxReadError::unsupported_span_granularity:  return "Texture data alignment is too strict";
      case BetxReadError::noncanonical_span_granularity: return "Line, plane, level, face, or layer span granularity is too large or smaller than a previous granularity";
