...
if not no_write then
   ...
   if file_ext == '.hpp' then
      ...
      write_template('common/templates/enum_scalar_mapping_decl', packing_components_map)
      ...
      write_template('common/templates/enum_scalar_mapping', packing_components_map)
