...
///////////////////////////////////////////////////////////////////////////////
std::size_t calculate_required_lineal_texture_size(const ImageFormat& format, I32 dim, std::size_t levels, TextureAlignment alignment) noexcept {
   return calculate_required_texture_size(TextureClass::lineal, format, ivec3(dim, 1, 1), 1, levels, alignment);
}

///////////////////////////////////////////////////////////////////////////////
std::size_t calculate_required_lineal_array_texture_size(const ImageFormat& format, I32 dim, std::size_t layers, std::size_t levels, TextureAlignment alignment) noexcept {
   return calculate_required_texture_size(TextureClass::lineal_array, format, ivec3(dim, 1, 1), layers, levels, alignment);
}

///////////////////////////////////////////////////////////////////////////////
std::size_t calculate_required_planar_texture_size(const ImageFormat& format, ivec2 dim, std::size_t levels, TextureAlignment alignment) noexcept {
   return calculate_required_texture_size(TextureClass::planar, format, ivec3(dim, 1), 1, levels, alignment);
}

///////////////////////////////////////////////////////////////////////////////
std::size_t calculate_required_planar_array_texture_size(const ImageFormat& format, ivec2 dim, std::size_t layers, std::size_t levels, TextureAlignment alignment) noexcept {
   return calculate_required_texture_size(TextureClass::planar_array, format, ivec3(dim, 1), layers, levels, alignment);
}

///////////////////////////////////////////////////////////////////////////////
std::size_t calculate_required_volumetric_texture_size(const ImageFormat& format, ivec3 dim, std::size_t levels, TextureAlignment alignment) noexcept {
   return calculate_required_texture_size(TextureClass::volumetric, format, dim, 1, levels, alignment);
}

///////////////////////////////////////////////////////////////////////////////
std::size_t calculate_required_directional_texture_size(const ImageFormat& format, ivec2 dim, std::size_t levels, TextureAlignment alignment) noexcept {
   return calculate_required_texture_size(TextureClass::directional, format, ivec3(dim, 1), 1, levels, alignment);
}

///////////////////////////////////////////////////////////////////////////////
std::size_t calculate_required_directional_array_texture_size(const ImageFormat& format, ivec2 dim, std::size_t layers, std::size_t levels, TextureAlignment alignment) noexcept {
   return calculate_required_texture_size(TextureClass::directional_array, format, ivec3(dim, 1), layers, levels, alignment);
}

///////////////////////////////////////////////////////////////////////////////
std::size_t calculate_required_texture_size(TextureClass tex_class, const ImageFormat& format, ivec3 dim, std::size_t layers, std::size_t levels, TextureAlignment alignment) noexcept {
   if (!is_array(tex_class)) {
      assert(layers == 1);
      layers = 1;
   }
   ...
   std::error_code ec;
   return calculate_required_texture_storage(layers, faces, levels, dim, format.block_dim(), format.block_size(), ec, alignment);
}
