#pragma once
#ifndef BE_GFX_TEX_TGA_READER_HPP_
#define BE_GFX_TEX_TGA_READER_HPP_
...
///////////////////////////////////////////////////////////////////////////////
class TgaReader final : public detail::DefaultTextureReader {
public:
   TgaReader(bool strict = false, Log& log = default_log());
