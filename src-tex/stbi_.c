...
typedef void* (*be_stbi_internal_load_func)(stbi__context*, int*, int*, int*, stbi__result_info*);
...
static void* be_stbi__load(be_stbi_internal_load_func func, stbi__context* s, int* x, int* y, int* comp, int* bpc) {
