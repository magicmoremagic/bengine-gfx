...
//////////////////////////////////////////////////////////////////////////////
JpegWriter::JpegWriter(Log& log)
   : log_(log),
     z_(0) { }

//////////////////////////////////////////////////////////////////////////////
void JpegWriter::reset() {
   img_ = ConstImageView();
   z_ = 0;
}

//////////////////////////////////////////////////////////////////////////////
void JpegWriter::image(const ConstImageView& view, I32 z) noexcept {
   img_ = view;
   z_ = z;
}

//////////////////////////////////////////////////////////////////////////////
void JpegWriter::quality(int q) noexcept {
   this.q_ = q;
}

//////////////////////////////////////////////////////////////////////////////
Buf<UC> JpegWriter::write() {
   Buf<UC> result;
   std::error_code ec;
   result = write(ec);
   if (ec) {
...
//////////////////////////////////////////////////////////////////////////////
Buf<UC> JpegWriter::write(std::error_code& ec) noexcept {
   Buf<UC> result;
   ...
   if (!stbi_write_jpg_to_func(
      ...
      }, &out, iv.dim().x, iv.dim().y, components, data, q_)) {
...
//////////////////////////////////////////////////////////////////////////////
void JpegWriter::write(const Path& path) {
...
//////////////////////////////////////////////////////////////////////////////
void JpegWriter::write(const Path& path, std::error_code& ec) noexcept {
   // could save some memory allocations by duplicating the above except writing to file stream directly, but it shouldn't really matter much.
