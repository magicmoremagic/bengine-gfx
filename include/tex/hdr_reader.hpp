#pragma once
#ifndef BE_GFX_TEX_HDR_READER_HPP_
#define BE_GFX_TEX_HDR_READER_HPP_
...
///////////////////////////////////////////////////////////////////////////////
class HdrReader final : public detail::DefaultTextureReader {
public:
   HdrReader(bool strict = false, Log& log = default_log());
