#pragma once
#ifndef BE_GFX_TEX_PNM_READER_HPP_
#define BE_GFX_TEX_PNM_READER_HPP_
...
///////////////////////////////////////////////////////////////////////////////
class PnmReader final : public detail::DefaultTextureReader {
public:
   PnmReader(bool strict = false, Log& log = default_log());
