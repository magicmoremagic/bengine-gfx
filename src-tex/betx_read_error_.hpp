...
enum class BetxReadError : U8 {
   ...
   unnecessary_levels,
   unsupported_span_granularity,
   noncanonical_span_granularity,
...
struct EnumTraits<::be::gfx::tex::detail::BetxReadError> {
   ...
   static C values() {
      return {
         ...
         ::be::gfx::tex::detail::BetxReadError::unsupported_span_granularity,
         ::be::gfx::tex::detail::BetxReadError::noncanonical_span_granularity,
         ...
         ::be::gfx::tex::detail::BetxReadError::invalid_component_type,
