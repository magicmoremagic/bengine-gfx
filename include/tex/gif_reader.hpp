#pragma once
#ifndef BE_GFX_TEX_GIF_READER_HPP_
#define BE_GFX_TEX_GIF_READER_HPP_
...
///////////////////////////////////////////////////////////////////////////////
class GifReader final : public detail::DefaultTextureReader {
public:
   GifReader(bool strict = false, Log& log = default_log());
