...
//////////////////////////////////////////////////////////////////////////////
HdrWriter::HdrWriter(Log& log)
   : log_(log),
     z_(0) { }

//////////////////////////////////////////////////////////////////////////////
void HdrWriter::reset() {
   img_ = ConstImageView();
   z_ = 0;
}

//////////////////////////////////////////////////////////////////////////////
void HdrWriter::image(const ConstImageView& view, I32 z) noexcept {
   img_ = view;
   z_ = z;
}

//////////////////////////////////////////////////////////////////////////////
Buf<UC> HdrWriter::write() {
   Buf<UC> result;
   std::error_code ec;
   result = write(ec);
   if (ec) {
...
//////////////////////////////////////////////////////////////////////////////
Buf<UC> HdrWriter::write(std::error_code& ec) noexcept {
   Buf<UC> result;
   ...
   for (glm::length_t c = 0; c < components; ++c) {
      ...
      if (img_.format().field_type(c) != FieldType::sfloat) {
         ec = make_error_code(TextureFileError::unsupported);
         return result;
      }
   }
...
//////////////////////////////////////////////////////////////////////////////
void HdrWriter::write(const Path& path) {
...
//////////////////////////////////////////////////////////////////////////////
void HdrWriter::write(const Path& path, std::error_code& ec) noexcept {
   // could save some memory allocations by duplicating the above except writing to file stream directly, but it shouldn't really matter much.
