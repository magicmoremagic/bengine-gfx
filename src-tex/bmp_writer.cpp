...
//////////////////////////////////////////////////////////////////////////////
BmpWriter::BmpWriter(Log& log)
   : log_(log),
     z_(0) { }

//////////////////////////////////////////////////////////////////////////////
void BmpWriter::reset() {
   img_ = ConstImageView();
   z_ = 0;
}

//////////////////////////////////////////////////////////////////////////////
void BmpWriter::image(const ConstImageView& view, I32 z) noexcept {
   img_ = view;
   z_ = z;
}

//////////////////////////////////////////////////////////////////////////////
Buf<UC> BmpWriter::write() {
   Buf<UC> result;
   std::error_code ec;
   result = write(ec);
   if (ec) {
...
//////////////////////////////////////////////////////////////////////////////
Buf<UC> BmpWriter::write(std::error_code& ec) noexcept {
   Buf<UC> result;
...
//////////////////////////////////////////////////////////////////////////////
void BmpWriter::write(const Path& path) {
...
//////////////////////////////////////////////////////////////////////////////
void BmpWriter::write(const Path& path, std::error_code& ec) noexcept {
   // could save some memory allocations by duplicating the above except writing to file stream directly, but it shouldn't really matter much.
